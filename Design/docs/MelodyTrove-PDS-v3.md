# MelodyTrove Product Design System v3
...
MelodyTrove uses a seed color to generate a complete light or dark Miuix color
...
| Default Manual Theme Seed | `#FF5B8A` (MelodyTrove Brand Pink). |
