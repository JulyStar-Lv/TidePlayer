...
- The GitHub repository currently remains `JulyStar-Lv/MelodyTrove`; documentation must not invent a `JulyStar-Lv/TidePlayer` clone URL until the repository itself is renamed.
