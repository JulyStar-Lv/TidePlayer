...
import io.github.julystar.musicapp.service.playback.data.AndroidAdvancedPlaybackController
...
actual val platformModule: Module = module {
    ...
    single<AdvancedPlaybackController> { AndroidAdvancedPlaybackController() }
}
